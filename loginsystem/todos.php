...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="nav-link" href="/loginsystem/welcome.php"style="color:white;">Back to Dashboard</a>
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/loginsystem/todos.php" method="POST">
...
<div class="container my-4">
    ...
    <form action="/loginsystem/todos.php" method="POST" class="Frm">
      <div class="form-group">
        <label for="title">Note Title</label>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `/loginsystem/todos.php?delete=${sno}`;
